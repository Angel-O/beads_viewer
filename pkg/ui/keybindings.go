...
func GetKeyBindingDocs() []KeyBindingDoc {
	...
	return []KeyBindingDoc{
		...
		{"tab", "Next Scope panel", "Navigation", "scope,global-issues"},
		{"shift+tab", "Previous Scope panel", "Navigation", "scope,global-issues"},
		...
		{"D", "Descope marked/current member", "Actions", "scope"},
