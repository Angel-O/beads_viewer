	...
	return []StructuredTutorialPage{
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyHint{
					{Key: "Status glyph", Desc: "Issue status"},
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				...
				Spacer{Lines: 1},
				Section{Title: "Contextual Movement"},
				KeyTable{Bindings: []KeyHint{
					{Key: "j", Desc: "Move down"},
					{Key: "k", Desc: "Move up"},
					{Key: "h", Desc: "Left/previous where shown"},
					{Key: "l", Desc: "Right/next where shown"},
				}},
				Spacer{Lines: 1},
				Section{Title: "Jump Commands"},
				KeyTable{Bindings: []KeyHint{
					{Key: "Home", Desc: "Jump to top in List view"},
					{Key: "G", Desc: "Jump to bottom"},
					{Key: "Ctrl+d", Desc: "Half-page down"},
					{Key: "Ctrl+u", Desc: "Half-page up"},
				}},
				Spacer{Lines: 1},
				Section{Title: "Contextual Keys"},
				KeyTable{Bindings: []KeyHint{
					{Key: "?", Desc: "Help overlay"},
					{Key: "Esc", Desc: "Close / go back"},
					{Key: "Enter", Desc: "Select, open, or drill where supported"},
					{Key: "q", Desc: "Close current view; quit from List"},
				}},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyHint{
					...
					{Key: "C", Desc: "Copy full issue to clipboard"},
					{Key: "y", Desc: "Copy issue ID"},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Split view appears automatically when the terminal is wider than 100 columns."},
				Spacer{Lines: 1},
				Section{Title: "Navigation"},
				KeyTable{Bindings: []KeyHint{
					{Key: "Tab", Desc: "Switch focus between panes"},
					{Key: "j / k", Desc: "Navigate in focused pane"},
					{Key: "C", Desc: "Copy full issue"},
					{Key: "y", Desc: "Copy issue ID"},
					{Key: "x", Desc: "Export markdown"},
				}},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyHint{
					...
					{Key: "e", Desc: "Cycle empty-column mode"},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Press m to toggle the Priority x Depth heatmap; Enter drills into a cell."},
			},
		},
		{
			ID:       "views-history",
			...
			Elements: []TutorialElement{
				...
				Spacer{Lines: 1},
				Section{Title: "Open Related Bead"},
				Paragraph{Text: "Press Enter to jump to the selected bead in the issue list."},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Press f from List view to open cross-label dependency flow."},
			},
		},
		{
			ID:      "advanced-export",
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Press x from List, Detail, or Split view to export the current state to markdown. Great for Slack, email, meeting notes."},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Press l to open the label filter, then choose one label."},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Use br update for assignment and label changes."},
				Spacer{Lines: 1},
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Paragraph{Text: "Find a good-first-issue: Press l, then select that label."},
				Spacer{Lines: 1},
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyHint{
					...
					{Key: "b/g/i/h", Desc: "Switch views from List/Detail"},
				}},
				Spacer{Lines: 1},
				Section{Title: "Navigation"},
				KeyTable{Bindings: []KeyHint{
					{Key: "j / k", Desc: "Move down/up"},
					{Key: "h / l", Desc: "Contextual left/right"},
					{Key: "Home / G", Desc: "List top/bottom"},
					{Key: "Enter", Desc: "Select, open, or drill where supported"},
				}},
				Spacer{Lines: 1},
				Section{Title: "Filtering"},
				KeyTable{Bindings: []KeyHint{
					...
					{Key: "o/c/r", Desc: "Status filters (open/closed/ready)"},
					{Key: "a", Desc: "Actionable view from List/Detail"},
				}},
				Spacer{Lines: 1},
